...
@ -I /home/allspark2020/Downloads/kyle_stock_kernel/GT-S7562_ICS_Opensource_Update1/arch/arm/include
@ -I arch/arm/include/generated -I include -I arch/arm/mach-msm/include
@ -imultilib armv7-a
@ -iprefix /home/allspark2020/android/toolchains/arm-linux-androideabi-4.7/bin/../lib/gcc/arm-linux-androideabi/4.7/
@ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm -D CC_HAVE_ASM_GOTO
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /home/allspark2020/android/toolchains/arm-linux-androideabi-4.7/bin/../lib/gcc/arm-linux-androideabi/4.7/include
...
@ -fzero-initialized-in-bss -mandroid -marm -mbionic -mlittle-endian
...
.LASF57:
	.ascii	"/home/allspark2020/Downloads/kyle_stock_kernel/GT-S"
	.ascii	"7562_ICS_Opensource_Update1\000"
.LASF37:
	.ascii	"PG_pinned\000"
.LASF19:
	.ascii	"PG_slab\000"
